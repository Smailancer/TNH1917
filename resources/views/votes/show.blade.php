<x-app-layout>
    ...
    <section id="voting" class="bg-gray-100 dark:bg-gray-900 p-3">
        <!-- Show Section Content -->
        <div class="my-3 p-5 flex justify-center bg-white dark:bg-gray-800 rounded-lg shadow-md max-w-screen-lg mx-auto">
            <div class="w-full">
                <h5 class="text-xl sm:text-lg font-bold dark:text-white pt-5 my-3">As {{ $vote->user->username }} :</h5>
                ...
                <select disabled id="countries_disabled" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                ...
                <h5 class="text-xl sm:text-lg font-bold dark:text-white py-5">Percentage</h5>
                <label for="disabled-range" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Percentage of land given to Israel to establish its state:</label>
                <input id="percentage-slider" type="range" value="{{ $vote->percentage }}" min="0" max="100" class="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer dark:bg-gray-700" disabled>

                <div class="flex items-center justify-between my-3">
                    <img src="../israel.png" alt="Country Flag" class="block rounded-full w-12 h-12 md:w-16 md:h-16 mt-2">
                    <p class="text-gray-900 dark:text-white text-sm sm:text-base">{{ $vote->percentage }}%</p>
                ...
                <h5 class="text-xl sm:text-lg font-bold dark:text-white py-5">Decisions</h5>
                <div class="my-3">
                    @foreach ($vote->options as $selectedOption)
                        <div class="flex items-center">
                            <input disabled checked id="disabled-checked-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600">
                ...
                <h5 class="text-xl sm:text-lg font-bold dark:text-white py-5">Notes</h5>
                <div class="my-3">
                    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your notes</label>
                    <textarea id="message" rows="4" class="block w-full text-gray-600 text-sm bg-gray-200 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white" disabled>
        ...
        <div class="my-6 p-5 flex justify-center bg-white dark:bg-gray-800 rounded-lg shadow-md max-w-screen-lg mx-auto">
            <div class="w-full">
                <h3 class="text-2xl sm:text-xl font-semibold text-gray-900 dark:text-white mb-4">Step 5:</h3>
                ...
                <div class="text-center">
                    <a href="{{ route('votes.downloadPdf', $vote->id) }}" class="px-5 py-3 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-blue-500 dark:hover:bg-blue-600">
                ...
                <form method="POST" action="{{ route('votes.updateActions', $vote->id) }}">            
                    ...
                    @method('PATCH')
                    <div class="mt-6">
                        <h6 class="text-lg font-semibold text-gray-800 dark:text-white">What have you done?</h6>
                        <div class="mt-2 space-y-2">
                            <label class="flex items-center">
                                <input type="checkbox" name="downloaded" {{ $vote->downloaded ? 'checked' : '' }} class="form-checkbox h-5 w-5 text-blue-600">
                                <span class="ml-2 text-gray-700 dark:text-gray-300">Downloaded the declaration</span>
                            </label>
                            <label class="flex items-center">
                                <input type="checkbox" name="sent_to_embassy" {{ $vote->sent_to_embassy ? 'checked' : '' }} class="form-checkbox h-5 w-5 text-blue-600">
                                <span class="ml-2 text-gray-700 dark:text-gray-300">Sent it to the embassy</span>
                            </label>
                            <label class="flex items-center">
                                ...
                                <span class="ml-2 text-gray-700 dark:text-gray-300">Published on social media</span>
                            </label>
                        </div>
