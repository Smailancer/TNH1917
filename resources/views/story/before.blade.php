    ...
    <li class="mb-5 ms-4">
        ...
        <a href="#" class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <div class="text-gray-600 dark:text-gray-400">
                ...
                <div class="text-sm font-normal">Among them are (36) female prisoners and about (170) children, while the number of administrative detainees is (1,264), including more than (20) children, and four female prisoners: (Raghad Al-Fanni, Samah Awad, Hanan Al-Barghouti, and Fatima Abu Shalal).</div>
