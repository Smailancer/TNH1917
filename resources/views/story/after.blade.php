    ...
    <div class="bg-white px-5 my-2">
        <ol class="relative border-s border-gray-200 dark:border-gray-700">
            ...
            <li class="mb-5 ms-4">
                ...
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">August 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Humanitarian Crisis Reaches Breaking Point</h3>
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">July 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Infrastructure Breakdown Escalates</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">June 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Death Toll Rises to 40,000</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">May 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Humanitarian Agencies Struggle to Help</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">April 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Gaza’s Infrastructure Crumbles</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">March 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Death Toll Exceeds 30,000</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">February 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Humanitarian Crisis Deepens</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">January 2024</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Ceasefire Talks Collapse</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">December 2023</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Mass Casualties and Infrastructure Collapse</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">November 2023</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Heavy Casualties in Gaza</h3>
                        <div class="text-sm font-normal">
            ...
            <li class="mb-5 ms-4">
                <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
                <time class="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-500">October 2023</time>
                <div class="items-center block p-3">
                    <div class="text-gray-600 dark:text-gray-400">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Hamas Attacks Israel, Conflict Erupts</h3>
                        <div class="text-sm font-normal">
